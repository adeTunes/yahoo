    ...
    <>
      <div className="col-1">
        <div className="row-1">
          ...
          >
            <div></div>
            <div style={{fontSize: '17px', fontWeight: 400}}>Subscriptions</div>
            <div ref={sortRef}>
              <p className="sort-group" onClick={handleSortList} style={{padding: '4px 16px', backgroundColor: '#f1f1f5', display: "flex", flexDirection: "row", gap: "5px", alignItems: "center"}}>
                Recommended
            ...
            <div className="pos-abs flex flex-col bg-white cl-default" style={{zIndex: '999', right: '330px', top: '156px', borderRadius: '2px', boxShadow: '0 0 10px rgb(0 0 0 / 30%)'}}>
              ...
              <div className="flex colgap-10 bg-abs cursor-p pad-lr-15 pad-tb-10">
                ...
                <p className="flex-1">Recommended</p>
              </div>
              <div className="flex colgap-10 bg-abs cursor-p pad-lr-15 pad-tb-10">
                <span className="wid-16"></span>
                <p className="flex-1">Name from A to Z</p>
              </div>
            </div> : 
              null
              }
          ...
          >
            <div style={{paddingLeft: '20px'}}>
              <ul className="flex" style={{color: '#1d2228', borderRadius: '2px', height: '24px', border: '1px solid rgba(79, 170, 255, 0.64)'}}>
                <li onClick={() => handleSubSelection(1)} className={subSelection === 1? "cursor-p fw-700 sub-selected" : 'cursor-p sub-back'} style={{borderRight: '1px solid rgba(79, 170, 255, 0.64)', padding: '0 16px'}}>Active</li>
                <li onClick={() => handleSubSelection(2)} className={subSelection === 2? "cursor-p fw-700 sub-selected" : 'cursor-p sub-back'} style={{padding: '0 16px'}}>Unsubscribed</li>
              </ul>
            </div>
          ...
          <div className="row-1-1" style={{ background: "#fff" }}>
            <div className="test-height grid" style={{height: '100%', placeItems: 'center'}}>
              <div className="flex flex-col align-it rowgap-20">
                <img src="./images/subscription-empty.png" alt="" height='160' width='160'/>
                <div style={{fontSize: '17px', color: '#828a93'}}>No subscriptions</div>
              </div>
            </div>
          </div>
        </div>
